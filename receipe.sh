...
#directory for other packages such as Nessus to have the deb downloaded intoicket
mkdir -p ~/live-build-config/kali-config/variant-light/package-lists/includes.chroot/packages

#Nessus .deb placed here
#~/live-build-config/kali-config/variant-light/package-lists/includes.chroot/opt/nessus
#download nessus


##Download files into th e packages dir
